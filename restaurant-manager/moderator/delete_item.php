...
<?php
	...
	{ 
		$myDBCON->deleteDB("DELETE FROM FoodOrder WHERE idItem=".$_POST[$keys[$i]]."");
		$myDBCON->deleteDB("DELETE FROM Item WHERE idItem=".$_POST[$keys[$i]]."");
	}
...
<body>
	...
	<div class="container">
	  <div class="jumbotron" style="background-image: url(../pictures/food-order.png); background-size:cover; color:white;">
	    ...
	    <p>You deleted <?echo sizeof($keys)-1;?> items!</p>
	  </div>
	</div>
</body>
</html>