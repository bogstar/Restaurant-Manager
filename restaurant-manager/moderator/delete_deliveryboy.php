...
<title>DELETE DELIVERYBOY</title>
...
<?php
	...
	{ 
		$myDBCON->deleteDB("DELETE FROM FoodOrder WHERE idDeliveryBoy=".$_POST[$keys[$i]]."");
		$myDBCON->deleteDB("DELETE FROM DeliveryBoy WHERE idDeliveryBoy=".$_POST[$keys[$i]]."");
	}
...
<body>
	...
	<div class="container">
	  <div class="jumbotron" style="background-image: url(../pictures/restaurant.png); background-size:cover; color:white;">
	    ...
	    <p>You fired <?echo sizeof($keys)-1;?> deliveryboys!</p>
	  </div>
	</div>
</body>
</html>